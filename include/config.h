...
constexpr double DUBINS_INTERPOLATION_STEP = 0.1; // in meters (useless to be more precise than the cell size)
...
constexpr double CELL_SIZE = 0.1;                 // in meters
...
constexpr double CAR_MAX_G_FORCE = 0.5;                     // in m/s^2
constexpr double CAR_ACCELERATION = 1;                      // in m/s^2
