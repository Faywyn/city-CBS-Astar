...
constexpr double CAR_ACCELERATION = 5.0f;                    // in m/s^2
constexpr double CAR_DECELERATION = 3.0f;                    // in m/s^2
...
constexpr double CAR_CBS_TIME_GAP = TIME_RESOLUTION;         // in seconds
