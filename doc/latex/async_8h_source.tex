\doxysubsection{async.\+h}
\hypertarget{async_8h_source}{}\label{async_8h_source}\index{async.h@{async.h}}
...
\DoxyCodeLine{\Hypertarget{async_8h_source_l00035}00035\ \textcolor{keyword}{struct\ }async\_factory\_impl\ \{}
...
\DoxyCodeLine{\Hypertarget{async_8h_source_l00037}00037\ \ \ \ \ \textcolor{keyword}{static}\ std::shared\_ptr<async\_logger>\ create(std::string\ logger\_name,\ SinkArgs\ \&\&...args)\ \{}
\DoxyCodeLine{\Hypertarget{async_8h_source_l00038}00038\ \ \ \ \ \ \ \ \ \textcolor{keyword}{auto}\ \&registry\_inst\ =\ details::registry::instance();}
...
\DoxyCodeLine{\Hypertarget{async_8h_source_l00046}00046\ \ \ \ \ \ \ \ \ \ \ \ \ tp\ =\ std::make\_shared<details::thread\_pool>(details::default\_async\_q\_size,\ 1U);}
...
\DoxyCodeLine{\Hypertarget{async_8h_source_l00058}00058\ \textcolor{keyword}{using\ }async\_factory\ =\ async\_factory\_impl<async\_overflow\_policy::block>;}
\DoxyCodeLine{\Hypertarget{async_8h_source_l00059}00059\ \textcolor{keyword}{using\ }async\_factory\_nonblock\ =\ async\_factory\_impl<async\_overflow\_policy::overrun\_oldest>;}
...
\DoxyCodeLine{\Hypertarget{async_8h_source_l00062}00062\ \textcolor{keyword}{inline}\ std::shared\_ptr<spdlog::logger>\ create\_async(std::string\ logger\_name,}
...
\DoxyCodeLine{\Hypertarget{async_8h_source_l00069}00069\ \textcolor{keyword}{inline}\ std::shared\_ptr<spdlog::logger>\ create\_async\_nb(std::string\ logger\_name,}
...
\DoxyCodeLine{\Hypertarget{async_8h_source_l00076}00076\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ init\_thread\_pool(\textcolor{keywordtype}{size\_t}\ q\_size,}
...
\DoxyCodeLine{\Hypertarget{async_8h_source_l00082}00082\ \ \ \ \ details::registry::instance().set\_tp(std::move(tp));}
\DoxyCodeLine{\Hypertarget{async_8h_source_l00083}00083\ \}}
\DoxyCodeLine{\Hypertarget{async_8h_source_l00084}00084\ }
\DoxyCodeLine{\Hypertarget{async_8h_source_l00085}00085\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ init\_thread\_pool(\textcolor{keywordtype}{size\_t}\ q\_size,}
...
\DoxyCodeLine{\Hypertarget{async_8h_source_l00088}00088\ \ \ \ \ init\_thread\_pool(q\_size,\ thread\_count,\ on\_thread\_start,\ []\ \{\});}
\DoxyCodeLine{\Hypertarget{async_8h_source_l00089}00089\ \}}
\DoxyCodeLine{\Hypertarget{async_8h_source_l00090}00090\ }
\DoxyCodeLine{\Hypertarget{async_8h_source_l00091}00091\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ init\_thread\_pool(\textcolor{keywordtype}{size\_t}\ q\_size,\ \textcolor{keywordtype}{size\_t}\ thread\_count)\ \{}
\DoxyCodeLine{\Hypertarget{async_8h_source_l00092}00092\ \ \ \ \ init\_thread\_pool(}
...
\DoxyCodeLine{\Hypertarget{async_8h_source_l00097}00097\ \textcolor{keyword}{inline}\ std::shared\_ptr<spdlog::details::thread\_pool>\ thread\_pool()\ \{}
\DoxyCodeLine{\Hypertarget{async_8h_source_l00098}00098\ \ \ \ \ \textcolor{keywordflow}{return}\ details::registry::instance().get\_tp();}
