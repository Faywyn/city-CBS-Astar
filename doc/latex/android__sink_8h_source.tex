\doxysubsection{android\+\_\+sink.\+h}
\hypertarget{android__sink_8h_source}{}\label{android__sink_8h_source}\index{android\_sink.h@{android\_sink.h}}
...
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00011}00011\ \textcolor{preprocessor}{\ \ \ \ \#include\ <spdlog/details/synchronous\_factory.h>}}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00012}00012\ \textcolor{preprocessor}{\ \ \ \ \#include\ <spdlog/sinks/base\_sink.h>}}
...
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00025}00025\ \textcolor{keyword}{namespace\ }spdlog\ \{}
...
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00037}00037\ \ \ \ \ \ \ \ \ :\ tag\_(std::move(tag)),}
...
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00065}00065\ \ \ \ \ \ \ \ \ \ \ \ \ throw\_spdlog\_ex(\textcolor{stringliteral}{"{}logging\ to\ Android\ failed"{}},\ ret);}
...
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00077}00077\ \ \ \ \ \textcolor{keyword}{typename}\ std::enable\_if<ID\ ==\ static\_cast<int>(log\_id::LOG\_ID\_MAIN),\ \textcolor{keywordtype}{int}>::type\ android\_log(}
...
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00083}00083\ \ \ \ \ \textcolor{keyword}{typename}\ std::enable\_if<ID\ !=\ static\_cast<int>(log\_id::LOG\_ID\_MAIN),\ \textcolor{keywordtype}{int}>::type\ android\_log(}
...
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00088}00088\ \ \ \ \ \textcolor{keyword}{static}\ android\_LogPriority\ convert\_to\_android\_(spdlog::level::level\_enum\ level)\ \{}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00089}00089\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{switch}\ (level)\ \{}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00090}00090\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ spdlog::level::trace:}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00091}00091\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ANDROID\_LOG\_VERBOSE;}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00092}00092\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ spdlog::level::debug:}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00093}00093\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ANDROID\_LOG\_DEBUG;}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00094}00094\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ spdlog::level::info:}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00095}00095\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ANDROID\_LOG\_INFO;}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00096}00096\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ spdlog::level::warn:}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00097}00097\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ANDROID\_LOG\_WARN;}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00098}00098\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ spdlog::level::err:}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00099}00099\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ANDROID\_LOG\_ERROR;}
\DoxyCodeLine{\Hypertarget{android__sink_8h_source_l00100}00100\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ spdlog::level::critical:}
