\doxysubsection{async\+\_\+logger.\+h}
\hypertarget{async__logger_8h_source}{}\label{async__logger_8h_source}\index{async\_logger.h@{async\_logger.h}}
...
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00023}00023\ \ \ \ \ block,\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Block\ until\ message\ can\ be\ enqueued}}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00024}00024\ \ \ \ \ overrun\_oldest,\ \ \textcolor{comment}{//\ Discard\ oldest\ message\ in\ the\ queue\ if\ full\ when\ trying\ to}}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00025}00025\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ add\ new\ item.}}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00026}00026\ \ \ \ \ discard\_new\ \ \ \ \ \ \textcolor{comment}{//\ Discard\ new\ message\ if\ the\ queue\ is\ full\ when\ trying\ to\ add\ new\ item.}}
...
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00033}00033\ \textcolor{keyword}{class\ }SPDLOG\_API\ async\_logger\ final\ :\ \textcolor{keyword}{public}\ std::enable\_shared\_from\_this<async\_logger>,}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00034}00034\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{public}\ logger\ \{}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00035}00035\ \ \ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{class\ }details::thread\_pool;}
...
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00039}00039\ \ \ \ \ async\_logger(std::string\ logger\_name,}
...
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00043}00043\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ async\_overflow\_policy\ overflow\_policy\ =\ async\_overflow\_policy::block)}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00044}00044\ \ \ \ \ \ \ \ \ :\ logger(std::move(logger\_name),\ begin,\ end),}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00045}00045\ \ \ \ \ \ \ \ \ \ \ thread\_pool\_(std::move(tp)),}
...
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00048}00048\ \ \ \ \ async\_logger(std::string\ logger\_name,}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00049}00049\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ sinks\_init\_list\ sinks\_list,}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00050}00050\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ std::weak\_ptr<details::thread\_pool>\ tp,}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00051}00051\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ async\_overflow\_policy\ overflow\_policy\ =\ async\_overflow\_policy::block);}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00052}00052\ }
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00053}00053\ \ \ \ \ async\_logger(std::string\ logger\_name,}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00054}00054\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ sink\_ptr\ single\_sink,}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00055}00055\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ std::weak\_ptr<details::thread\_pool>\ tp,}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00056}00056\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ async\_overflow\_policy\ overflow\_policy\ =\ async\_overflow\_policy::block);}
...
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00061}00061\ \ \ \ \ \textcolor{keywordtype}{void}\ sink\_it\_(\textcolor{keyword}{const}\ details::log\_msg\ \&msg)\ \textcolor{keyword}{override};}
...
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00063}00063\ \ \ \ \ \textcolor{keywordtype}{void}\ backend\_sink\_it\_(\textcolor{keyword}{const}\ details::log\_msg\ \&incoming\_log\_msg);}
...
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00067}00067\ \ \ \ \ std::weak\_ptr<details::thread\_pool>\ thread\_pool\_;}
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00068}00068\ \ \ \ \ async\_overflow\_policy\ overflow\_policy\_;}
...
\DoxyCodeLine{\Hypertarget{async__logger_8h_source_l00073}00073\ \textcolor{preprocessor}{\ \ \ \ \#include\ "{}async\_logger-\/inl.h"{}}}
